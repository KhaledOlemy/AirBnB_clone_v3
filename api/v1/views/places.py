...
#     if states:
#         for state in states:
#             city_ids += [city.id for city in storage.all(City).values()
...
#         amenities_as_objects = [storage.get(Amenity, a_id) for
#                                 a_id in amenities]
#         places = [place for place in places if all([amenity in
#                                                     place.amenities for
#                                                     amenity in
#                                                     amenities_as_objects])]
#         qualified_places = []
#         for place in places:
...
def search_places():
    ...
    desired_places = [place for place in places if all([amenity in
                                                        place.amenities
                                                        for amenity in
                                                        desired_amenities])]
